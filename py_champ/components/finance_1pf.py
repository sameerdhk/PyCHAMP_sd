...
class Finance(mesa.Agent):
    ...
    def load_settings(self, settings: dict):
        ...
        self.pumping_fee = settings["pumping_fee"]        
    ...
    def step(self, fields: dict, wells: dict) -> float:       
        ...
        # Calculate pumping fees
        # cost_p = irr_vol * self.pumping_fee
    ...
    def step_pf(self, fields: dict, wells: dict) -> float:
        """
        Perform a single step of financial calculations.
        ...
        profit = rev - cost_p - cost_e - cost_tech - tech_change_cost - crop_change_cost
        self.y = y  # (n_s, n_c, 1) [1e4 bu] of all fields
        self.rev = rev
        self.cost_e = cost_e
        self.cost_p = cost_p
