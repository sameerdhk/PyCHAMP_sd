...
from ..components.behavior_pa import Behavior
...
from ..utility.util_pa import BaseSchedulerByTypeFiltered, Indicator, TimeRecorder
    ...
    **kwargs : dict
    ...
    def __init__(
        ...
        **kwargs,
        ...
        #Initialize accumulated withdrawal
        self.accumulated_withdrawal = 0  # Initialize accumulated pumping
        
        #cutoff withdrawal value
        self.withdrawal_cutoff = 1896.11
        ...
        agent_reporters = {
            ...
            "zero_irrigation_reason": get_agt_attr("zero_irrigation_reason"),
            "irrigation_depth_from_optimization": get_agt_attr("store_irr_depth"),
            # Well
